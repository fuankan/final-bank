package kg.fkapps.finalbank.selectUser
...
class UserSelectRecyclerViewAdapter(val userList: ArrayList<UserData>, var toUserId: Array<Int>) :
    RecyclerView.Adapter<UserSelectRecyclerViewAdapter.UserSelectItem>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): UserSelectItem {
        val v = LayoutInflater.from(parent.context)
            .inflate(R.layout.single_select_user_layout, parent, false)
        return UserSelectItem(v)
    }
    ...
    class UserSelectItem(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            ...
            selectBtn = itemView.findViewById(R.id.selected_btn)
        }
    }
}